...
# 数据集路径
DATA_DIR = './data/custom_scolopacidae_dataset'

if is_colab():
  DATA_DIR = '/content/drive/MyDrive/data/custom_scolopacidae_dataset'
  NUM_CLASSES = 200
  NUM_EPOCHS = 30

# 自定义数据集类
class CustomScolopacidaeDataset(Dataset):
...
def main():
    ...
    # 加载数据集
    train_dataset = CustomScolopacidaeDataset(DATA_DIR, is_train=True, transform=transform['train'])
    val_dataset = CustomScolopacidaeDataset(DATA_DIR, is_train=False, transform=transform['val'])
